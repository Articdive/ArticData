...
<dependencies>
    <dependency>
        ...
        <version>1.19.4-6e644906</version>
    </dependency>
</dependencies>
```
...
dependencies {
    implementation("de.articdive:articdata:1.19.4-6e644906")
}
```
...
|:-----------------------------:|:-------------------:|
|         Namespace ID          | :heavy_check_mark:  |
| Carvers, Features & Creatures | :heavy_check_mark:  |
|         Mob Spawning          | :heavy_check_mark:  |
...
|            Offset            |         :x:         | Handled in Functions as of (1.19.4) |
|     Has Offset Function      | :heavy_check_mark:  |                                     |
