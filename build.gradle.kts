...
tasks {
    register("generateData") {
        ...
        // CodeGeneration
        val projectCG: Project = project(":CodeGenerator:$closestVersion")
        dependsOn(projectCG.tasks.getByName<JavaExec>("run") {
            ...
            // finally compile.
        }).finalizedBy(project(":AutoGenerated").tasks.getByName<Jar>("jar"))
    }
}
